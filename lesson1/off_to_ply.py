...
def write_ply_points_only_from_off(ply_data_dir, off_data_dir):
    """
    把ModelNet数据集文件从.off格式改成.ply格式，只包含points
    :param ply_data_dir: ply文件的存放路径
    :param off_data_dir: off文件的存放地址
    :return:
    """
...
def write_ply_points_faces_from_off(ply_data_dir, off_data_dir):
    """
    把ModelNet数据集文件从.off格式改成.ply格式，包含points和faces
    :param ply_data_dir: ply文件的存放路径
    :param off_data_dir: off文件的存放地址
    :return:
    """
...
def main():
    # ply目标文件产生路径
    ply_data_dir = '/home/mitom/3DPointCloud/data/ModelNet40_PLY'
    # off文件所在路径
    off_data_dir = '/home/mitom/3DPointCloud/data/ModelNet40_OFF'
